    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        build: function() {
            return {
                ...
                isBlured: function() {
                    if (this.blurClickedElement === true)
                        return true;
        ...
        clean: function() {
            return {
                ...
                restoreSelectionMarker: function(html) {
                    html = html.replace(/&lt;span id=&quot;selection-marker-([0-9])&quot; class=&quot;redactor-selection-marker&quot; data-verified=&quot;redactor&quot;&gt;â€‹&lt;\/span&gt;/g, '<span id="selection-marker-$1" class="redactor-selection-marker" data-verified="redactor">â€‹</span>');
                    return html
                },
        ...
        list: function() {
            return {
                ...
                remove: function(cmd, $list) {
                    if ($.inArray('ul', this.selection.getBlocks()))
                        cmd = 'unorderedlist';
                    document.execCommand('insert' + cmd);
                    var $current = $(this.selection.getCurrent());
                    this.indent.fixEmptyIndent();
